 ...
 *
 * Contains the ServiceRepository class.
 *
...
class ServiceRepository
{
    ...
    {           
        ...
        $this->pageContext->setPage(INDY_PATH . "/view/error.view.php");
        
        $this->pageContext->setAttribute("Message", "Unknown Service requested [$serviceName] with id [$id]");
        $this->pageContext->setAttribute("Exception", null);

...
3. Dollar Notation, a way of easily putting values into a markup pages without the
   need for PHP 'echo' command.
...
Custom Tags      : Beta   - These work, but there are a few tweaks that need to be 
                   made to improve them, and one or two known bugs and missing
                   features.
Dollar Notation  : Alpha  - Works for basic notations ${somevalue} and ${class.method}
                   need to add more variations fo 

Latest Changes - 3rd March 2012
==============

Improved Exception Handling, should be no more White Screens of Death. The error message 
    (and possibly) an exception should show on the page.
Improved logging
